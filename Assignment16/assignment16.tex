...
\begin{align}
6\vec{A}^{-1}=a\vec{A}^2+b\vec{A}+c\vec{I} \label{eq:1}
...
\implies\vec{A}(\vec{A}^2+4\vec{A}+\vec{I})= 6\vec{I} \label{eq:2}
\end{align}
$\mydet{\vec{A}} =6 \neq 0$ hence inverse exists. Hence \eqref{eq:2} we get,
\begin{align}
6\vec{A}^{-1} = \vec{A}^2+4\vec{A}+\vec{I} \label{eq:3}
\end{align} 
Comparing \eqref{eq:1} and \eqref{eq:3} we get,
\begin{align}

...
\begin{abstract}
This document contains QR-decomposition of a 2x2 matrix.
\end{abstract}
Download the python codes from 
%
\begin{lstlisting}
https://github.com/pranaya14014/EE5609/tree/master/Assignment6/code
\end{lstlisting}
%
and latex-tikz codes from 
%
\begin{lstlisting}
https://github.com/pranaya14014/EE5609/tree/master/Assignment6
\end{lstlisting}
%
\section{PROBLEM}
Find the QR decomposition of 
\begin{align}
\vec{A}=\myvec{8&5\\3&2} \label{eq:1}
\end{align}
\section{SOLUTION}
...
\end{align}
where $\vec{a}$ and $\vec{b}$ are column vectors. From \eqref{eq:1}
\begin{align}
\vec{a}=\myvec{8\\3}\label{eq:2}\\
\vec{b}=\myvec{5\\2}\label{eq:3}
\end{align}
The QR decomposition of the given matrix is given by
\begin{align}
\vec{A}=\vec{Q}\vec{R} \label{eq:4}
\end{align}
...
\vec{R}=\myvec{r_1&r_2\\0&r_3} \label{eq:5}
\end{align}
...
r_3 = \vec{q_2^T}\vec{b}
\end{align}
Subtituting \eqref{eq:2} and \eqref{eq:3} we get
\begin{align}
...
\end{align}
Hence subtituting these values in \eqref{eq:5} and then back in \eqref{eq:4} we get,
\begin{align}

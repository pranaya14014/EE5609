...
\begin{longtable}{|c|l|}
\hline
\multirow{3}{*}{\textbf{Option 1}} & \\ & \textbf{The matrix of second order partial derivatives of the quadratic form of $\vec{Q}$ is $2\vec{A}$.}\\
\hline
...
\multirow{3}{*}{\textbf{Option 2}} &\\ & \textbf{The rank of the quadratic form of $\vec{Q}$ is 2}\\
\hline
...
\multirow{3}{*}{\textbf{Option 3}} & \\ & \textbf{The signature of the quadratic form $\vec{Q}$ is $(++0)$}\\
\hline
\multirow{3}{*}{Solution} & From above we have quadratic form of $\vec{Q}$ = \myvec{2&2&0\\2&0&-2\\0&-2&2}\\
...
\multirow{3}{*}{\textbf{Option 4}} &\\ & \textbf{The quadratic form $\vec{Q}$ takes the value 0 for some non-zero vector $(x,y,z)$}\\
\hline
\multirow{3}{*}{Solution} & From above we have quadratic form of $\vec{Q}$ = \myvec{2&2&0\\2&0&-2\\0&-2&2}\\ &

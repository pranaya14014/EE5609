...
\item[(b)] Show that for any $\vec{\alpha}$ in $\mathbb{R}^2$ we have
\begin{align}
...
\begin{align}
(\alpha^T\gamma)= -1 \\
\implies \myvec{1\\2}^T\gamma =-1 \label{eq:1}
\end{align}
from $\beta = \myvec{-1\\ 1}$ and $(\beta^T\gamma)=3$ we get,
\begin{align}
(\beta^T\gamma)=3\\
\implies \myvec{-1\\ 1}^T\gamma = 3 \label{eq:2}
\end{align}
...
\begin{align}
\alpha = \alpha_1\epsilon_1+ \alpha_2\epsilon_2 = \alpha^T\myvec{\epsilon_1\\\epsilon_2} \label{eq:3}
\end{align}
...
=\alpha^T\myvec{1\\0}\\
\implies(\alpha^T\epsilon_1)\epsilon_1=\alpha^T\myvec{\epsilon_1\\0} \label{eq:4}\\
...
=\alpha^T\myvec{0\\1}\\
\implies(\alpha^T\epsilon_2)\epsilon_2=\alpha^T\myvec{0\\\epsilon_2} \label{eq:5}
\end{align}
using \eqref{eq:4} and \eqref{eq:5} we can write,
\begin{align}
(\alpha^T\epsilon_1)\epsilon_1 + (\alpha^T\epsilon_2)\epsilon_2 = \alpha^T\myvec{\epsilon_1\\0} + \alpha^T\myvec{0\\\epsilon_2}\\
\implies (\alpha^T\epsilon_1)\epsilon_1 + (\alpha^T\epsilon_2)\epsilon_2 = \alpha^T\myvec{\epsilon_1\\\epsilon_2} \label{eq:6}
\end{align}
hence using \eqref{eq:3}and \eqref{eq:6} we get,
\begin{align}
